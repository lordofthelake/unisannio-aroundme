 ...
 * {@see onData(T)}. In caso di errori, dovrebbe essere notificato il metodo onError(Exception). A seconda dell'implementazione, il caricamento pu&ograve; essere sincrono
 * o asincrono.
 * 
...
public interface DataListener<T> {
	...
	/**
	 * Metodo richiamato nel momento in cui il caricamento dei dati &egrave; stato completato.
	 * 
