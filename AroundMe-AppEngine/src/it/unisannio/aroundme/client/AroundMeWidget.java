...
import it.unisannio.aroundme.client.MyRequestFactory.HelloWorldRequest;
import it.unisannio.aroundme.client.MyRequestFactory.MessageRequest;
import it.unisannio.aroundme.shared.MessageProxy;

public class AroundMeWidget extends Composite {
  ...
  interface AroundMeUiBinder extends UiBinder<Widget, AroundMeWidget> {
  }

  private static AroundMeUiBinder uiBinder = GWT.create(AroundMeUiBinder.class);
